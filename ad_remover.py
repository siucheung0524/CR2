...
1. 【必須保留的正片 (keep_intervals)】：
   ...
   - 【流行歌曲與音樂】：節目中播放的流行歌曲（主持人在話題之間播歌，例如「聽隻歌返嚟再講」或段落尾聲播歌）屬於電台節目正片內容，【絕對不可切除】！必須與前後對話連貫保留！
...
2. 【四個段落（Parts 1~4）的起止點判定規範】：
   - 【Part 1（約 10:00~10:30）】：
     ...
     * 終點：10:30 商業廣告與報時開始前。若主持人在話題結束後播了一首流行歌再入廣告，歌曲必須連貫保留，切口落在歌曲結束、廣告/報時開始的一剎那。
   - 【Part 2（約 10:30~11:00）】：
     * 起點：10:30 廣告結束後，主持人說話或音樂接回之處（約 1650s~1700s）。
     * 終點：【極度重要】必須依據逐字稿實際語意！主持人們在 11:00 前結束話題的時間各集皆不同（可能在 2980s 結束，也可能一直熱聊到 3180s）。【絕對不可在主持人和嘉賓還在聊天途中提前截斷】！只有當主持人明確結束話題，隨後緊接著商業廣告、宣傳聲帶或 11:00 新聞報時之處，才是 Part 2 終點！
   ...
   - 【Part 4（約 11:30~12:00）】：
     * 起點：【極度重要】11:30 廣告結束後，單元專屬 Jingle（如 Everyday is 新day、雞仔好人、衰佬CLS 等）響起或主持立刻開場介紹新話題之處，必須完整保留 Jingle 與開頭介紹，【絕不可延遲 20~30 秒才切入】！
...
{{
  "keep_intervals": [
    ...
    {{"start": 1685.0, "end": 3180.0, "description": "Part 2: 10:30 破口後接回至 11:00 前主持對話真正結束處"}},
    {{"start": 3698.0, "end": 4958.8, "description": "Part 3: 11:00 新聞後 Jingle 接回至 11:30 廣告前（切除後續口水多過浪花宣傳與報時）"}},
    {{"start": 5380.0, "end": 6692.0, "description": "Part 4: 11:30 單元 Jingle 至節目完結道別結束（切除後續商業廣告與12:00新聞）"}}
  ]
}}
